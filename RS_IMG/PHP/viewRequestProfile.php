...
if(isset($_POST['aID'])&& isset($_POST['reqID']))
{
    ...
    $stmt = $reqManager->conn->prepare("SELECT ROW_NUMBER() OVER (ORDER BY reqID) AS SNo, ASSIGNMENTS.aID ,reqID, aName, IternNo, Name, aDeadline FROM REQUESTS JOIN ASSIGNMENTS ON ASSIGNMENTS.aID = REQUESTS.aID JOIN STUDENTS ON STUDENTS.Student_ID = REQUESTS.Student_ID WHERE $condition");
...
<script src="../SCRIPTS/viewRequestProfile.js"></script>
</html>
